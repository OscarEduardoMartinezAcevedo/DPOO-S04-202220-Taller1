...
public class ConsolaOlimpicos
{
	...
	private void ejecutarAtletaEnPais()
	{
		System.out.println("\n" + "Atleta de un país" + "\n");

		String pais = input("Por favor ingrese el nombre de un atleta");
		List<Map<String, Object>> paises = calculadora.atletaEnPais(pais);
		if (paises == null)
		{
		...
		{
			for (Map<String, Object> datos : paises)
			{
				String nombre = (String) datos.get("nombre");
				String pais = (String) datos.get("pais");
				System.out.println(" - " + pais + " en " + anio + " --> " + nombre);
			}
		}
	}
	/**
